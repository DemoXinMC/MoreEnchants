...
public class ItemCharm extends Item
{
	...
	public void addEnchants()
	{
		...
		if(MoreEnchants.enchantRegen != null)
		    validEnchants.add(MoreEnchants.enchantRegen);
		if(MoreEnchants.enchantMagnet != null)
		    validEnchants.add(MoreEnchants.enchantMagnet);
	}
	...
	{	
		...
		else if (fEvent.source.damageType == "arrow" && fEvent.source.getSourceOfDamage() instanceof EntityArrow)
		{
